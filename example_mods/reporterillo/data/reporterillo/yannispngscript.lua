...
idle_xml_name = 'YannisPNG-Idle0'
left_xml_name = 'YannisPNG-Left0'
down_xml_name = 'YannisPNG-Down0'
up_xml_name = 'YannisPNG-Up0'
right_xml_name = 'YannisPNG-Right0'
...
name_of_character_xml = 'YannisPNG'
name_of_character = 'YannisPNG2'
charNote = 'yannispng'
